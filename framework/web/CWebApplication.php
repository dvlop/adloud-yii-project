 ...
 * @property Geo $geo The user session information.
 * @property WebUser $user The user session information.
 * @property \application\modules\payment\extensions\curl\Curl $curl
 * @property \application\modules\payment\extensions\currency\Currency $currency
 ...
 * @property SocialModule $social
 * @property YiiMail $mail The Yii mail-sender component.
