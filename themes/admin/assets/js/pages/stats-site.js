...
StatsSite = {
        ...
        if(typeof data != 'undefined'){
            ...
            $.each(attributes, function(index, element){
                if(typeof data[element] != 'undefined')
                    StatsSite[element] = data[element];
            });
        }

        StatsSite.setHandlers();
    },

    setHandlers: function(){
        StatsSite.setColors();
        StatsSite.setCharts();
        StatsSite.setDatePicker();
    },

    setColors: function(){
        for(var key in StatsSite.categoriesData){
            StatsSite.categoriesData[key].color = StatsSite.colors[key];
        }
    },

    setCharts: function(){
        new Chart(document.getElementById(StatsSite.categoriesId).getContext("2d")).Pie(StatsSite.categoriesData,{
            animateRotate : false
        });
    },
    ...
    setDatePicker: function(){
        ...
        $(StatsSite.dateSubmitId).on('click', function(){
