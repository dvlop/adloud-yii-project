...
<head>
    ...
    <title>Добро пожаловать на бета-тестирование <?php echo $systemName; ?>!</title>
    <style>
            ...
            <table width="600" bgcolor="#34495e" cellpadding="0" cellspacing="0" border="0" align="center" class="deviceWidth" height="98px" style="border-radius: 4px 4px 0 0;">
                ...
                <tr>
                    <td style="color:#ffffff; font-size:15px; padding:0 90px; vertical-align:middle;" class="ResponsPadding">
                        <p>Добро пожаловать на бета-тестирование AdLoud!</p>
                    </td>
            ...
            <table width="600" bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" class="deviceWidth" height="130px">
                ...
                <tr>
                    <td style="padding:0 90px;" class="ResponsPadding">
                        <p style="color:#727272;">Здравствуйте, <?php echo $userName; ?>! <br>Мы очень рады, что Вы с нами, и с нетерпением ждем Ваших отзывов — они помогут нам улучшить нашу тизерную сеть и предоставить вам больше возможностей для заработка!</p>
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <tr>
        <td>
            <table width="600" bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" class="deviceWidth" height="53px">
                ...
                <tr>
                    <td style="padding:0 90px;" class="ResponsPadding">
                        <p style="color:#727272; font-size: 18px;">Ваш ключ: <span style="color:#429ef7;"><?php echo $invite; ?></span> - <a href="<?php echo $backUrl; ?>" style="color:#F39C12;">Активировать</a></p>
                    </td>
                </tr>
                </tbody>
            </table>
...
<table width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:1px;">
    ...
    <tr>
        <td>
            <table width="600" bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" class="deviceWidth" height="180px" style="border-radius: 0 0 4px 4px;">
                <tbody>
                <tr>
                    <td style="padding:0 90px; color:#727272;" class="ResponsPadding">
                        <p>Возникли вопросы?<br>Обязательно свяжись с нами, чтобы обсудить детали:</p>
                        <p><br>Email – <?php echo $supportEmail; ?><br>Skype – <?php echo $supportSkype; ?></p>
                        <br>
                        <p>С уважением, служба поддержки компании <?php echo $systemName; ?>.</p>
                    </td>
                </tr>
                </tbody>
            </table>
