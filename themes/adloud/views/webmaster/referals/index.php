 ...
 * @var \application\models\ReferalStats[] $referals
 */
?>
    <div class="col-sm-12 referal">
        <div class="col-sm-12 ref_url">
            <div class="row">
                <p class="ref_url_title col-md-3 col-sm-12"><?php echo Yii::t('advertiser_referals', 'Реферальная ссылка'); ?></p>
                ...
                <div class="col-md-3 col-sm-6">
                    <button class="btn adloud_btn btn-block btn-embossed copy_ref_url" data-clipboard-target="ref-link-text" id="copy-btn">
                        <span class="input-icon fui-exit pull-left"></span><?php echo Yii::t('advertiser_referals', 'Скопировать в буфер'); ?>
                    </button>
                </div>
            </div>
        </div>
        <legend><?php echo Yii::t('advertiser_referals', 'Статистика'); ?></legend>
        <?php if($referals): ?>
            <table class="table table-striped table-hover adloud_table referal_stat">
                <thead>
                <tr>
                    <th class="col-sm-2"><?php echo Yii::t('advertiser_referals', 'Имя пользователя'); ?></th>
                    <th class="col-sm-6"><?php echo Yii::t('advertiser_referals', 'Дата регистрации'); ?></th>
                    <th class="col-sm-4"><?php echo Yii::t('advertiser_referals', 'Сумма комиссионных'); ?></th>
                </tr>
                </thead>
                <tbody>
        ...
        <?php else: ?>
            <?php echo Yii::t('advertiser_referals', 'У вас нет реферальных начислений'); ?>
        <?php endif; ?>
    </div>
