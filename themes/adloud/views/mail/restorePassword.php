...
<table width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" style="border-bottom:1px solid #ffffff;">
    ...
    <tr>
        <td>
            <table width="600" bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" class="deviceWidth" height="100px">
                <tbody>
                <tr>
                    <td style="padding:0 90px;" class="ResponsPadding">
                        <p style="color:#727272;">Мы получили запрос на изменение пароля к вашему аккаунту. Пожалуйста, воспользуйтесь ниже указанной ссылкой для создания нового пароля.</p>
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <tr>
        <td>
            <table width="600" bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" class="deviceWidth" height="53px">
                ...
                <tr>
                    <td style="padding:0 90px;" class="ResponsPadding">
                        <?php echo CHtml::link('...восстановить пароль', $url, ['style' => 'color:#429ef7;']) ?>
                    </td>
                </tr>
                </tbody>
            </table>
...
<table width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" style="border-bottom:1px solid #ffffff;">
    ...
    <tr>
        <td>
            <table width="600" bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0" align="center" class="deviceWidth" height="123px" style="border-radius: 0 0 4px 4px;">
                <tbody>
                <tr>
                    <td style="padding:0 90px; color:#727272;" class="ResponsPadding">
                        <p>Если же вы не отправляли запрос, <br>можете спокойно проигнорировать это сообщение.</p>
                        <br />
